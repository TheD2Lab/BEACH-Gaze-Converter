...
**SPECIAL CASE**: After the installation, st-dbscan must be modified in order for the scripts to work. Currently,
...
function
- **Please keep in mind**: if you already have files of the same name as the outputted files, the files will be appended to or
