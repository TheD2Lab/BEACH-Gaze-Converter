...
- Inputs: csv file that follows WebGazer format (x,y,TIME,TIMETICK) and a csv file that contains the parameters used for ST-DBSCAN. 
    - [sample csv file](https://github.com/TheD2Lab/BEACH-Gaze-Converter/tree/main/raw_WG_data_sample) of the raw WebGazer data
    - [sample csv file](https://github.com/TheD2Lab/BEACH-Gaze-Converter/tree/main/best_params_sample) of the paramters that are needed for ST-DBSCAN. These come from
    the tuning script
...
- Inputs: csv file with the starting points and folder path for WebGazer data. [sample csv file](https://github.com/TheD2Lab/BEACH-Gaze-Converter/tree/main/elbow_knee_values_sample) that comes from the find elbow script. 
